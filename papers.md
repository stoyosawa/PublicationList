...
- Satoshi Toyosawa & Takashi Kawai,
	"Frame disparity statistics for subject stereoscopic sensation evaluation",
...
- Satoshi Toyosawa & Takashi Kawai,
	"Subjective evaluation on heart-rate-variability based video digest",
	Institute of Image Information and Television Engineers Technical Report, 19-5 (September 2006).

- Satoshi Toyosawa & Takashi Kawai,
	"On physiological structures of heart-rate-variability based video digests",
...
- Satoshi Toyosawa & Takashi Kawai,
	"Crowd congestion evaluation in public space from interframe images",
...
- Akio Kobayashi, Satoshi Toyosawa & Takashi Kawai,
	"A system for detecting an elderly dementia patient leaving the bed for preventing sudden disappearance and consideration on the sensor layouts",
	The 8th Annual conference of Biophilia Rehabilitation Academy, p. 14 (August 2004).

- Satoshi Toyosawa & Takashi Kawai,
	"Determining pedestrian density in public space from the number of colours in images",
...
- Satoshi Toyosawa & Hiroyuki Yamaguchi,
	"Empirical rules on window layout",
