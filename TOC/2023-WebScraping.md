...
- Chapter 5: Character wordcloud from a Japanese zipped text (Dazai, "No Longer Human") [Requests, Beautiful Soup, Janome, WordCloud]
...
- Chapter 12: CSVs and geolocations - Japanese train stations (Japan e-Gov API) [Requests, Pandas, Plotly]
- Appendix:
	- Advanced topics
	- References
	- A list of scripts
